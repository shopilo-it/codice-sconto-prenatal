#!/usr/bin/env python3
"""
Recupero codici sconto Prenatal da shopilo.it
Sursa: https://shopilo.it/negozi/prenatal.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/prenatal.it"
STORE_NAME = "Prenatal"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Prenatal da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-prenatal)"
    }
    try:
